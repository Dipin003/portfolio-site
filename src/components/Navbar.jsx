    ...
    return (
        <div className="fixed top-0 left-0 w-full z-50 ">
            <div className="flex justify-between items-center max-w-screen-xl px-3 xs:mx-auto xs:px-10 py-5">
                <div className="flex gap-3 xs:gap-6 items-center text-sm xs:text-lg sm:text-xl text-gray-500">
                    <a href="#"><BsTwitterX /></a>
                    <a href="https://github.com/Dipin003" rel="noopener noreferrer" target="_blank"><BsGithub /></a>
                    <a href="https://www.instagram.com/dipinkharayat_03?igsh=MWo4ajdqaXZmcWc4bQ==" target="_blank" rel="noopener noreferrer"><BsInstagram /></a>
